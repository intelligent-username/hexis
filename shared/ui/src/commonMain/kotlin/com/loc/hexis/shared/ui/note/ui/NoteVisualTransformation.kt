...
/**
 * Hides markdown prefixes and applies line-level rich text styling. The user sees the rendered
 * result; the underlying storage is markdown.
 */
class NoteVisualTransformation : VisualTransformation {
    ...
    override fun filter(text: AnnotatedString): TransformedText {
        ...
        for ((li, line) in lines.withIndex()) {
            ...
            val isListItem =
                line.type == LineType.BULLET_LIST || line.type == LineType.NUMBERED_LIST
            ...
            val style =
                when (line.type) {
                    ...
                    LineType.SUB_SUB_HEADER ->
                        SpanStyle(fontSize = 16.sp, fontWeight = FontWeight.Medium)
