...
import com.loc.hexis.platform.R
...
class HexisNotificationManager(private val context: Context) {
    ...
    fun habitNotification(habit: Habit) {
        ...
        val contentIntent =
            AppIntents.openMain(context, WidgetActions.OPEN_HABITS, fromNotification = true)
    ...
    fun taskNotification(task: Task) {
        ...
        val contentIntent =
            AppIntents.openMain(context, WidgetActions.OPEN_TASKS, fromNotification = true)
        val contentPendingIntent =
            PendingIntent.getActivity(
                context,
                0,
